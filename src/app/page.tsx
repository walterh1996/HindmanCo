...
import { ArrowRight, Users, TrendingUp, Megaphone, PenTool, BarChart3, Target } from "lucide-react";
...
const testimonials = [
  {
    quote:
      "Betsy and her team transformed how our executive team shows up on LinkedIn. The results have been measurable and the feedback from our board has been exceptional.",
    ...
    <>
          ...
          <div className="max-w-3xl">
            ...
            <FadeIn delay={0.2}>
              <p className="text-lg md:text-xl text-text-secondary leading-relaxed max-w-2xl mb-10">
                A boutique strategic advisory for executives, brand leaders, and
                innovators who want LinkedIn to do real work — not just exist.
              </p>
            </FadeIn>
            <FadeIn delay={0.3}>
        ...
        <div className="container-narrow">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-12 gap-y-6">
            {clients.map((client, i) => (
              <FadeIn key={client} delay={0.05 * i}>
                <span className="text-lg md:text-xl font-serif italic text-text-secondary/60">
                  {client}
                </span>
              </FadeIn>
            ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <FadeIn>
              <div>
                ...
                <p className="text-cream/70 leading-relaxed mb-4">
                  ...
                  the communications teams at companies like Microsoft, AT&amp;T,
                  and Nasdaq.
                </p>
                <p className="text-cream/70 leading-relaxed mb-8">
                  Before founding Hindman Company, Betsy built and led marketing
                  teams at high-growth startups and worked at the intersection of
                  media, brand, and technology. She is a recognized speaker and
                  has been featured in Forbes, Entrepreneur, and Fast Company.
                </p>
                <Link
                  href="/about"
            ...
            <FadeIn delay={0.15} direction="left">
              <div className="relative">
                <div className="aspect-[4/5] bg-cream/10 rounded-sm" />
      ...
      <section className="py-24 md:py-32 bg-accent">
        <div className="container-narrow text-center">
          ...
          <FadeIn delay={0.1}>
            <h2 className="font-serif italic text-3xl md:text-4xl lg:text-5xl leading-[1.15] text-foreground mb-6 max-w-2xl mx-auto">
